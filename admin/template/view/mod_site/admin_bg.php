...
<div class="wp-background-bgcolor-sample" id="backcolor_div2" <?if(!empty($seria_arr['color'])){?>style="background-image: none; background-color: <?php echo $seria_arr['color'];?>;" <?php }?> onclick="dialog_global.setFontColor();">
