    ...
    <tbody>
       ...
       <!--
		...
		<tr>
        	...
        	<td colspan="3" class="entry">
            <input type="radio" name="mi[open_style]"  value="1" <?php if($curr_mi->open_style=='1'){echo 'checked';}?>/>&nbsp;<?php _e('Yes'); ?>&nbsp;
            <input type="radio" name="mi[open_style]"  value="0" <?php if($curr_mi->open_style=='0'){echo 'checked';}?> />&nbsp;<?php _e('No'); ?>&nbsp;
            </td>
        </tr>
		-->
        <tr>
