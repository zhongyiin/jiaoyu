...
<span id="loginform_stat" style="text-align:center;margin-top:28px;	color:#999999;font-family:Arial,Helvetica,sans-serif;display:block;font-size:12px;">欢迎使用企业网站
管理系统</span>
<div id="footer">
<?php if((Toolkit::getAgent() && !IS_INSTALL) || (ToolKit::getCorp() && IS_INSTALL)){ echo $footer; }else{ ?><?php }?>
</div>