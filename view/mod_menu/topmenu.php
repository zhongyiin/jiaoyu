...
if (!function_exists('showMenu')) {
    ...
    <?php
            if (sizeof($menu->slaves['MenuItem']) > 0) {
                $level++;
    ?>
    <span><a href="<?php if($menu->mi_category == 'outer_url'){ echo $menu->link; }else echo $menu->link; ?>" <?php if($menu->open_style == '1'){echo "target='_blank'";}else{echo "target='_self'";}?>>
    ...
    ?>
    <a href="<?php  echo $menu->link; ?>" <?php if($menu->open_style == '1'){echo "target='_blank'";}else{echo "target='_self'";}?>>
    <?php echo $menu->name; ?></a>
    <?php
            }
    ?>
